# This is the file 'googleuse.py' which is adopted from 'examples' folder of SentEval.
# This is used for comparison of the universal sentence encoder of google with my encoder. Detailed comparison can be seen in the main README.txt
